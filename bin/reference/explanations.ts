...
const EXPLANATIONS: Record<RecordKey<Id<Section>>, Explanation> = {
    "staves": `StaffCode generates staff pieces and leger lines automatically after a <b>ston</b> (<b>st</b>aff <b>on</b>) comman, and any staff-piece code will change what kind of staff is generated. The default is <b>st5ln</b> (<b>st</b>aff <b>5</b> <b>l</b>i<b>n</b>es).` as Explanation,
