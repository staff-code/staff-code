...
import {BRAVURA_TEXT_SC, BRAVURA_TEXT_SC_OTF} from "../../../src/gui/constants"
...
ntqrdn st16 13; ntqrdn 3; st16 10; ntqrdn 6; st8 7; ntqrdn 1; st16 12; ntqrdn 4; st16 9; ntqrdn 7; st8 6; ntqrdn 2; st16 11; ntqrdn 5; st8 8; st8 4; bldb 4;` as Code & Sentence
    ...
    describe("*** Smart Stave ***", (): void => {
        ...
        it("provides leger lines of the smallest size which is wider than the glyph they are for, up to 48", (): void => {
            let actual
            let expectedUnicode
            let expectedCodes
            ...
            expect(debugCodeSentence(actual)).toBe(expectedCodes)
            saveVisualRegressionSpecSvg(actual, thisJasmine.currentTest, "lgln6")
            ...
            expect(debugCodeSentence(actual)).toBe(expectedCodes)
            saveVisualRegressionSpecSvg(actual, thisJasmine.currentTest, "lgln11")
            ...
            expect(debugCodeSentence(actual)).toBe(expectedCodes)
            saveVisualRegressionSpecSvg(actual, thisJasmine.currentTest, "lglnwd15")
            ...
            expect(debugCodeSentence(actual)).toBe(expectedCodes)
            saveVisualRegressionSpecSvg(actual, thisJasmine.currentTest, "lglnwd21")
        })
