...
const SAGITTAL_ACCIDENTAL_MAP: Record<Code, Symbol> = {
    /*U+E300*/[Code[`|(`]]: {unicode: "", width: 5, description: "5:7 kleisma up, (5:7k, ~11:13k, 7C less 5C)"},
    /*U+E301*/[Code[`!(`]]: {unicode: "", width: 5, description: "5:7 kleisma down"},
    /*U+E302*/[Code[`/|`]]: {unicode: "", width: 5, description: "5 comma up, (5C), 1° up [22 27 29 34 41 46 53 96-EDOs], 1/12-tone up"},
    /*U+E303*/[Code[`\\!`]]: {unicode: "", width: 5, description: "5 comma down, 1° down [22 27 29 34 41 46 53 96-EDOs], 1/12-tone down"},
    /*U+E304*/[Code[`|)`]]: {unicode: "", width: 5, description: "7 comma up, (7C), 1° up [43-EDO], 2° up [72-EDO], 1/6-tone up"},
    /*U+E305*/[Code[`!)`]]: {unicode: "", width: 5, description: "7 comma down, 1° down [43-EDO], 2° down [72-EDO], 1/6-tone down"},
    /*U+E306*/[Code[`//|`]]: {unicode: "", width: 8, description: "25 small diesis up, (25S, ~5:13S, ~37S, 5C plus 5C), 2° up [53-EDO]"},
    /*U+E307*/[Code[`\\\\!`]]: {unicode: "", width: 8, description: "25 small diesis down, 2° down [53-EDO]"},
    /*U+E308*/[Code[`/|)`]]: {unicode: "", width: 9, description: "35 medium diesis up, (35M, ~13M, ~125M, 5C plus 7C), 2/9-tone up"},
    /*U+E309*/[Code[`\\!)`]]: {unicode: "", width: 9, description: "35 medium diesis down, 1°[50] 2°[27] down, 2/9-tone down"},
    /*U+E30A*/[Code[`/|\\`]]: {unicode: "", width: 11, description: "11 medium diesis up, (11M), 1°[17 31] 2°46 up, 1/4-tone up"},
    /*U+E30B*/[Code[`\\!/`]]: {unicode: "", width: 11, description: "11 medium diesis down, 1°[17 31] 2°46 down, 1/4-tone down"},
    /*U+E30C*/[Code[`(|)`]]: {unicode: "", width: 11, description: "11 large diesis up, (11L), (sharp less 11M), 3° up [46-EDO]"},
    /*U+E30D*/[Code[`(!)`]]: {unicode: "", width: 11, description: "11 large diesis down, 3° down [46-EDO]"},
    /*U+E30E*/[Code[`(|\\`]]: {unicode: "", width: 12, description: "35 large diesis up, (35L, ~13L, ~125L, sharp less 35M), 2°50 up"},
    /*U+E30F*/[Code[`(!/`]]: {unicode: "", width: 12, description: "35 large diesis down, 2° down [50-EDO], 5/18-tone down"},
