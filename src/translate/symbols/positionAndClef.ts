...
const CLEF_MAP: Record<Code, Symbol> = {
    /*U+E050*/[Code[`tbcf`]]: {unicode: "", width: 22, description: "treble"},
    /*U+E05C*/[Code[`alcf`]]: {unicode: "", width: 22, description: "alto"},
    /*U+E062*/[Code[`bscf`]]: {unicode: "", width: 22, description: "bass"},
    /*U+E512*/[Code[`8va`]]: {unicode: "", width: 22, description: "octave above"},
    /*U+E51C*/[Code[`8vb`]]: {unicode: "", width: 22, description: "octave below"},
...
const GENERIC_POSITION_MAP: Record<Code, Symbol> = {
    ...
    /*U+F3F0*/[Code[`up0`]]: {unicode: "", width: 0},
...
const TREBLE_POSITION_MAP: Record<Code, Symbol> = {
    ...
    [Code[`b4`]]: GENERIC_POSITION_MAP[Code[`up0`]],
...
const BASS_POSITION_MAP: Record<Code, Symbol> = {
    ...
    [Code[`d3`]]: GENERIC_POSITION_MAP[Code[`up0`]],
...
const MANUAL_POSITION_MAP: Record<Code, Symbol> = {
    ...
    [Code[`tbb4`]]: GENERIC_POSITION_MAP[Code[`up0`]],
    ...
    [Code[`bsd3`]]: GENERIC_POSITION_MAP[Code[`up0`]],
