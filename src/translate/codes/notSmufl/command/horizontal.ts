...
const SET_NEWLINE_ADVANCE_COMMAND_CODE = "nl" as Command & Code & Word
const SET_PLACE_AGAINST_END_OF_STAFF_ADVANCE_COMMAND_CODE = "en" as Command & Code & Word
...
const NOT_SMuFL_SMART_ADVANCE_COMMAND_MAP: Record<RecordKey<Code & Word>, Unicode & Word> = {
    ...
    [SET_PLACE_AGAINST_END_OF_STAFF_ADVANCE_COMMAND_CODE]: EMPTY_UNICODE,
    [SET_RIGHT_ALIGN_ADVANCE_COMMAND_CODE]: EMPTY_UNICODE,
    [SET_CENTER_ALIGN_ADVANCE_COMMAND_CODE]: EMPTY_UNICODE,
} as Record<Code & Word, Unicode & Word>
...
export {
    ...
    SET_RIGHT_ALIGN_ADVANCE_COMMAND_CODE,
    SET_CENTER_ALIGN_ADVANCE_COMMAND_CODE,
