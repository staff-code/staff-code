...
const ADVANCE_TO_END_COMMAND_CODE = "en;" as Command & Code & Word
const RIGHT_ALIGN_COMMAND_CODE = "rt;" as Command & Code & Word
const CENTER_ALIGN_COMMAND_CODE = "cn;" as Command & Code & Word
...
const NOT_SMuFL_SMART_ADVANCE_COMMAND_MAP: Record<RecordKey<Code & Word>, Unicode & Word> = {
    ...
    [ADVANCE_TO_END_COMMAND_CODE]: EMPTY_UNICODE,
    [RIGHT_ALIGN_COMMAND_CODE]: EMPTY_UNICODE,
    [CENTER_ALIGN_COMMAND_CODE]: EMPTY_UNICODE,
} as Record<Code & Word, Unicode & Word>
...
export {
    ...
    RIGHT_ALIGN_COMMAND_CODE,
    CENTER_ALIGN_COMMAND_CODE,
