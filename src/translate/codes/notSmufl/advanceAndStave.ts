...
const NOT_SMuFL_SMART_STAVE_MAP: Record<RecordKey<Codeword>, Symbol> = {
    /*U+E40C*/"ston": {unicode: "", width: 0},
    /*U+E40D*/"stof": {unicode: "", width: 0},
} as Record<Codeword, Symbol>

const NOT_SMuFL_SMART_SPACING_MAP: Record<RecordKey<Codeword>, Symbol> = {
...
const NOT_SMuFL_MANUAL_ADVANCE_MAP: Record<RecordKey<Codeword>, Symbol> = {
...
const NOT_SMuFL_SMART_ADVANCE_MAP: Record<RecordKey<Codeword>, Symbol> = {
